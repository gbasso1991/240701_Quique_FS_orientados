...
owon.set_channel(channel=CH1,range='0.2v',offset=0.5,probe='1x',coupling=AC)
owon.set_channel(channel=CH2,range='10v',offset=0.5,probe='1x',coupling=AC)
